...
Pixel = Iterable[int, int, int]
Imagen = np.ndarray


def dibuja_fondo(color: Pixel, tamano: Iterable[int, int] = (1920, 1080)) -> Imagen:
...
def aplicar_vineta(img: Imagen, sigma: int = 200) -> Imagen:
    """Aplica una viñeta a una imagen

    Args:
        img (Imagen): La imagen a la que se le va a aplicar la viñeta.
        sigma (int, optional): Valor de la intensidad. Defaults to 200.

    Returns:
        Imagen: Imagen con la viñeta aplicada.
    """
